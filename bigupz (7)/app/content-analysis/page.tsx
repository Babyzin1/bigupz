...
import { TrendingUp, BarChart2, Clock, Hash, Award, Info } from "lucide-react"
      ...
      <main className="flex-1 p-4 md:p-8 pb-16 md:pb-8 mobile-pb">
        <div className="max-w-6xl mx-auto">
          ...
          <Alert className="mb-8">
            ...
            <AlertTitle>Unified Analysis</AlertTitle>
            <AlertDescription>
              Our AI analyzes both your captions and images together to provide comprehensive insights. Upload an image
              and write a caption to get the most accurate predictions.
            </AlertDescription>
          </Alert>
              ...
              <Card className="bigupz-card">
                ...
                <CardContent>
                  <p className="text-foreground/70 mb-4">
                    Our AI-powered content analyzer evaluates both your captions and images against millions of viral
                    posts to determine their potential.
                  </p>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-foreground/70">
                          We analyze caption length, structure, keywords, sentiment, image composition, colors, and
                          subject matter to identify patterns that drive engagement.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
              ...
              <Card className="bigupz-card">
                ...
                <CardContent>
                  ...
                  <div className="mt-6 p-4 border rounded-lg bg-muted/30">
                    ...
                    <p className="text-sm text-foreground/70">
                      Creators who use our Content Analyzer before posting see an average 43% increase in engagement
                      compared to unanalyzed content.
                    </p>
                  </div>
                </CardContent>
              </Card>
